...
<svg class="xmark" width={size} height={size} viewBox="0 0 44 44" fill="currentColor" aria-hidden="true">
  <polygon points="7.56,6 21.56,6 36.44,38 22.44,38" />
  <polygon points="33.06,6 41.56,6 10.94,38 2.44,38" />
</svg>
